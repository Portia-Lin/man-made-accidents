...
<img src="images/photos/RX.jpg" width="600">

Було протестовано дальність роботи. Максимальна дальність становить: **1,2 км**. Висота підйому передавача при цьому приблизно 6м. Висота підйому приймача - 1,7м.
